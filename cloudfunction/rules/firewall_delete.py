...
def firewall_delete(message, token, url, channel):
	...
	try:
		targetTags = message['protoPayload']['request']['targetTags']
	except:
		targetTags = message['protoPayload']['resourceOriginalState']['targetTags']
	...
	attachments = [
			{
				...
				"color":"#36a64f",
				"fallback":"["+ project_name +"] Firewall Delete Alert",
